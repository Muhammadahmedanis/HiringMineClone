...
function Footer() {
    return(
        <footer style={{background: "linear-gradient(180deg, #4d3bdb 0%, #9747ff 100%)"}} className="pt-3">
            <div className="w-full max-w-screen-xl mx-auto px-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="mb-6 text-sm font-medium text-white sm:mb-0 dark:text-white">
                ...
                <span className="block text-sm text-white text-center dark:text-white text-[18px] py-1"> <a className="hover:underline">Privacy Policy</a> Terms & Conditions</span>
                <span className="block text-sm text-white text-center dark:text-white text-[17px] pb-2"> Copyright Hiringmine 2024. All Rights Reserved </span>
        </footer>
    )
}
