...
function Navbar({ setDark }) {
    ...
    return (
        <>
            <nav className={`${isDark ? 'bg-slate-900 text-white' : 'bg-white text-gray-900'} z-10 fixed pt-4 px-4 top-0 w-full border-gray-200`}>
                <div className="max-w-screen-xl flex flex-wrap items-center justify-around mx-auto">
                    ...
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        ...
                        <label className="inline-flex items-center ms-5 cursor-pointer">
                            <input type="checkbox" className="sr-only peer" checked={isDark} onChange={handleThemeToggle} />
                            ...
                            <div className="items-center justify-center w-auto cursor-pointer order-3 md:order-1 lg:order-1 my-4 mx-auto" id="navbar-cta">
                                <div className="w-[350px] md:w-[550px] lg:w-[600px] px-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="search" id="default-search" className="bg-transparent block w-full pe-6 py-[14px] ps-16 text-[13px] lg:text-[17px] text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Job titles or companies " required />
                                        <button type="submit" className="text-white absolute end-2 bottom-2 bg-[rgb(104,81,255)] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm px-2 lg:px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Find Jobs</button>
                                    </div>
                                </div>
                            </div>
                        )
