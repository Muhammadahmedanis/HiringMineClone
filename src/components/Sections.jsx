...
function Sections(){
    ...
    return(
        <div className='dark:bg-slate-700 text-white pb-3 pt-20'>
        <div className="text-center pt-12 pb-4 lg:max-w-[1000px] mx-auto">
           <h1 style={{ background: 'linear-gradient(106.43deg, #522fd4, #6bdcff 95.12%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', fontWeight: '750'}} className="font-normal pb-4 text-4xl lg:text-7xl"> Dig. Apply <div>Prepare Your Future</div> </h1>
            ...
            <p className="text-[20px] text-center text-black dark:text-white">Hiring Mine connects employer and job seekers, where employers are the source of the resources and the job seeker can find and apply for their targeted job.</p>
            ...
            <div className='pt-16'>
                <div className="my-3 mx-auto max-w-screen-lg ">
                    <h3 className="text-3xl lg:text-5xl font-bold text-center text-black">Find Your Dream Job <span className="text-[#6851ff]">Super Fast Ever</span></h3>
                    <p className="text-xl text-center py-1 text-black">We are here to help jobseekers connect with organizer and companies. We are provides the best opportunities to professional people.</p>
                    <div className="py-6">
                        <img src="https://www.hiringmine.com/assets/banner_career-4b7d86fb.webp" alt="" />
                    </div>
                    <div className="py-4">
                        <h3 className="text-[25px] lg:text-[40px] font-bold text-center text-black"> <span className="text-[#6851ff]">Countless Career Options</span> Are Waiting For You To Explore </h3>
                    </div>
                </div>
                    ...
                    <div className="py-4 my-2">
                        <h3 className="text-5xl font-bold text-center text-black"> <span className="text-[#6851ff]">Latest And Top</span> Job Openings</h3>
                    </div>
...
function Card({jobTitle, image, totalJobs}) {
    ...
    return(
        <div className={`${themeMode == 'light' ? 'bgImage2' : 'dark:bg-gray-800'} flex items-center justify-center flex-col min-w-[300px] h-48 p-4 shadow-md shadow-slate-400  border border-gray-200 rounded-xl  dark:border-gray-700`}>
            <img className="text-[rgb(104,81,255)] py-2 bg-transparent" src={image} alt="" />
            <a href="#">
                <h5 className="mb-2 text-xl font-bold tracking-tight text-[rgb(104,81,255)] dark:text-gray-400">{jobTitle}</h5>
            </a>
